...
// -----------------------------------------------------------------------------
const char* ELRS_BIND_PHRASE = "CHANGE_ME";  // Same binding phrase as your ExpressLRS radios
// Replace this MAC with the ESP32 peer you need to talk to (print WiFi.macAddress() on that device)
